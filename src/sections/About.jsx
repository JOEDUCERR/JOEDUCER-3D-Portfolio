  ...
  return <section className='c-space section-spacing'>
    ...
    <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        <div className="flex items-end grid-default-color grid-1">
            ...
            <div className="z-10">
              <p className="headtext">Hi, I'm Joeducer</p>
              <p className="subtext">Over the last 4 years, I developed my Artificial Intelligence
                and machine learning
                skills to deliver dynamic responive and intelligent software
